                ...
                <div className='maxW relative z-10'>
                    <article className='flex items-center flex-col lg:w-1/2 lg:items-start'>
                        ...
                        <div className='mt-6 flex justify-center lg:justify-start'>
                            <a className='bg-GreenP py-3 px-8 font-DM text-md uppercase tracking-wider text-white border-2 border-GreenP hover:bg-transparent hover:border-white transition duration-300 ease-in-out' href="/Bastidores">Saiba mais</a>
                        </div>
                    </article>
                </div>
            </section>
