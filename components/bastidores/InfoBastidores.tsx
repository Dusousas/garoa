...
export default function InfoBastidores() {
    return (
        <section className='bg-BrownS py-20'>
            <div className='maxW flex flex-col gap-20'>

                <article className='w-full lg:w-[60%] self-start border-l-4 border-GreenP pl-6'>
                ...
                <article className='w-full lg:w-[60%] self-end border-r-4 border-GreenP pr-6 text-right'>
